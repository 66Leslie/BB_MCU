...
unsigned char adc_read(unsigned char ch){
    unsigned char temp;
    I2CStart();
    I2CSendByte(0x90);//1001000
    I2CWaitAck();
    I2CSendByte(0x40+ch);
    I2CWaitAck();
    //the same as the figure and should to start
    I2CStart();
	I2CSendByte(0x91);//10010000
    I2CWaitAck();
    temp = I2CReceiveByte();
    I2CSendAck(1);
    I2CStop();
...
void dac_out(unsigned char val){
    I2CStart();
    I2CSendByte(0x90);//10010000
    I2CWaitAck();

    I2CSendByte(0x43);//10010000
    I2CWaitAck();

    I2CSendByte(val);//10010000
    I2CWaitAck();
